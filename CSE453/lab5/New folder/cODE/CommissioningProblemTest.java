...
class CommissioningProblemTest {
    ...
    public void testStocksMin() {
        ...
        double sales = commission.calSale();
        assertEquals(406.0, commission.calCommission(sales), DELTA);
    }
    ...
    public void testStocksMax() {
        ...
        double sales = commission.calSale();
        assertEquals(880.0, commission.calCommission(sales), DELTA);
    }
    ...
    public void testBarrelsMin() {
        ...
        double sales = commission.calSale();
        assertEquals(420.0, commission.calCommission(sales), DELTA);
    }
    ...
    public void testBarrelsMax() {
        ...
        double sales = commission.calSale();
        assertEquals(865.0, commission.calCommission(sales), DELTA);
    }
    ...
    public void testCommissionAt1800() {
        ...
        double sales = commission.calSale();
        assertEquals(260.0, commission.calCommission(sales), DELTA);
    }
    ...
    public void testAllMax() {
        ...
        double sales = commission.calSale();
        assertEquals(1420.0, commission.calCommission(sales), DELTA);
    }
